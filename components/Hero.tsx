  ...
  return (
    <div>
      <h1 className="sr-only">
        I'm Asha Maurya. I'm a software developer. I love coding and data.
      </h1>
      <motion.div
            ...
            <div className="-mt-36">
              <div ref={ref} className="flex cursor-default flex-col space-y-2">
                ...
                <FadeUp duration={0.6} delay={0.2}>
                  <h5 className="text-3xl font-medium opacity-80 sm:text-6xl md:text-6xl xl:text-7xl">
                    I solve problems, then code.
                  </h5>
                </FadeUp>
